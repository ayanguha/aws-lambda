...
class TutorialInfo(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    TutorialTitle = db.Column(db.String(1024), unique=False, nullable=False)
...
class TipsNewsInfo(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    TipsNewsTitle = db.Column(db.String(1024), unique=False, nullable=False)
    TipsNewsDescription = db.Column(db.UnicodeText(), unique=False, nullable=False)
    TipsNewsHyperink = db.Column(db.String(1024), unique=False, nullable=False)
    TipsNewsType = db.Column(db.String(100), unique=False, nullable=False)
    ReleasedDate = db.Column(db.DateTime(), unique=False, nullable=False)
    isActive = db.Column(db.Boolean(), unique=False, nullable=False)
    postedOn = db.Column(db.DateTime(), unique=False, nullable=False)
...
class FirmwareInfo(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    FirmwareFileLink = db.Column(db.String(1024), unique=False, nullable=False)
    CompatibleDevice = db.Column(db.UnicodeText(), unique=False, nullable=False)
    ReleasedDate = db.Column(db.DateTime(), unique=False, nullable=False)
    isActive = db.Column(db.Boolean(), unique=False, nullable=False)
    postedOn = db.Column(db.DateTime(), unique=False, nullable=False)
